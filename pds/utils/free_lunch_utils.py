...
def register_free_upblock2d(model, b1=1.2, b2=1.4, s1=0.9, s2=0.2, timestep=500, t_b1=0.9, t_b2=0.9):
    """
            ...
            **kwargs
            ...
            for resnet in self.resnets:
                ...
                if 'timestep' in kwargs:
                    ...
                    b1 = self.b1 if timestep < self.timestep else self.t_b1
                    b2 = self.b2 if timestep < self.timestep else self.t_b2
    ...
    for i, upsample_block in enumerate(model.unet.up_blocks):
        if isinstance_str(upsample_block, "UpBlock2D"):
            ...
            setattr(upsample_block, 'timestep', timestep)
            setattr(upsample_block, 't_b1', t_b1)
            setattr(upsample_block, 't_b2', t_b2)
...
def register_free_crossattn_upblock2d(model, b1=1.2, b2=1.4, s1=0.9, s2=0.2, timestep=500, t_b1=0.9, t_b2=0.9):
    """
...
def register_free_upblock2d_in(model, b1=1.2, b2=1.4, s1=0.9, s2=0.2, check=None):
    """
    Register UpBlock2D with FreeU for UNet2DCondition.
    """
...
def register_free_crossattn_upblock2d_in(model, b1=1.2, b2=1.4, s1=0.9, s2=0.2, check=None):
    """
    Register CrossAttn UpBlock2D with FreeU for UNet2DCondition.
    """
